...
- [`.claude/skills/latesh-backfill-issues/SKILL.md`](.claude/skills/latesh-backfill-issues/SKILL.md) and [`.claude/skills/latesh-update-issues/SKILL.md`](.claude/skills/latesh-update-issues/SKILL.md): the two skills that carry out that process.
...
- `data/ingestion/state.yaml` is hand-initialized once, then maintained only by the `/latesh-update-issues` skill after a person confirms a publish. Do not hand-edit it once an update has run.
