...
- This file is hand-maintained. It is the one exception to the rule of `../CONTEXT.md` — no script generates it, and `npm run import:feedback` must never overwrite it.
