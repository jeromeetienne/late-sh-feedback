...
## Purpose
Tracks which commit of `mpiorowski/late-sh` was last read when turning `bugs.txt` and `suggestions.txt` into GitHub issues. See `../../docs/ingestion_process.md` for the full process.
